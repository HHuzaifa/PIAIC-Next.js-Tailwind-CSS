...
const Card: FC<{
  ...
  return (
    <motion.div whileHover={{ scale: 1.1 }} className="flex flex-col items-center relative justify-center bg-white px-2 py-6 md:w-80 lg:w-72 xl:w-96 group overflow-hidden rounded-2xl">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-full h-full opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out bg-white bg-opacity-50 backdrop-blur-xl p-4 flex items-center justify-center">
          <div>
            <p className="text-black text-lg my-10 lg:text-xl text-justify">{para}</p>
